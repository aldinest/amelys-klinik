        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                    <a href="{{ route('pengurus.medical-records.cetak', $medicalRecord->id) }}" 
                    target="_blank" 
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm border-0" style="border-radius: 0;">
                <div class="card-header py-3" style="background-color: #3ba2ac; color: white;">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-history mr-2"></i> Riwayat Pemeriksaan & Pengobatan</h3>
                </div>
                    ...
                    @foreach ($history as $row)
                        <div class="card shadow-sm border-0 mb-3" style="border-radius: 8px;">
                            <div class="card-body p-3">
                                ...
                                <div class="mb-2 p-2 rounded" style="background-color: #f8f9fa; border-left: 3px solid #dee2e6;"><small class="text-muted d-block font-weight-bold" style="font-size: 0.65rem;">KELUHAN</small><span class="text-dark" style="font-size: 0.85rem;">{{ $row->complaint }}</span></div>
                                @if($row->doctor_notes)
                                <div class="mb-0 p-2 rounded" style="background-color: #fffde7; border-left: 3px solid #ffd54f;"><small class="text-muted d-block font-weight-bold" style="font-size: 0.65rem;">CATATAN</small><span class="text-dark italic" style="font-size: 0.85rem;">{{ $row->doctor_notes }}</span></div>
                                @endif
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="card-body pt-0 pb-4">
                    <a href="{{ route('pengurus.medical-records.index') }}" class="btn px-4 py-2 font-weight-bold shadow-sm" style="background-color: #6c757d; color: white;">

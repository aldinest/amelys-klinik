...
<div class="content-wrapper">
    ...
    <section class="content-header pb-2">
        <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap">
            <h1 class="fw-bold mb-0">Tambah Jadwal Dokter</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary">
                    <strong class="text-white">Form Jadwal Dokter (Display)</strong>
                </div>

                <form method="POST"
                      action="{{ route('admin.doctor-display-schedules.store') }}">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('specialty') }}"
                                   placeholder="Contoh: Penyakit Dalam (Opsional)">
                            @error('specialty')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

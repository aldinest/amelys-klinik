                    ...
                    @if(!$patient->user_id)
                        <div class="callout callout-warning border-left shadow-sm py-2 mb-4">
                            <p class="small mb-0 text-muted">
                                ...
                                Pasien ini belum memiliki akun aplikasi. Masukkan email untuk aktivasi.
                            </p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <p class="small text-muted italic mt-2 ml-1">
                                        <i class="fas fa-key mr-1"></i> Password otomatis: <strong class="text-danger">password123</strong>
                                    </p>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="py-2">
                            <div class="d-inline-flex align-items-center p-3 border rounded bg-light shadow-none">
                                ...
                                <div class="text-left">
                                    ...
                                    <small class="text-muted">Pasien sudah bisa menggunakan email terdaftar untuk masuk ke aplikasi.</small>
                                </div>
                            </div>
                        </div>
                    @endif
